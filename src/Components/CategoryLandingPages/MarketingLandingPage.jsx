...
export default function MarketingLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center py-20 bg-gradient-to-br from-slate-900 via-orange-900 to-amber-900 overflow-hidden">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-600 p-5 rounded-full shadow-2xl">
                  <TrendingUp className="h-12 w-12 text-white" strokeWidth={2} />
                </div>
              </div>
            </div>

            {/* Badge */}
            <Badge className="mb-4 bg-gradient-to-r from-orange-500 to-amber-600 text-white border-0 px-6 py-2 text-base shadow-lg">
            ...
            {/* Subheading */}
            <p className="text-base md:text-lg lg:text-xl text-orange-100 max-w-4xl mx-auto mb-6 leading-relaxed">
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/20">
                    <StatIcon className={`h-6 w-6 mx-auto mb-2 text-orange-400`} />
                    <div className="text-2xl font-bold bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent mb-1">
                      {stat.value}
                    </div>
